"""
Hierarchical Bayesian Factorization Machine
...
This enables per-chemical uncertainty estimation, decomposed into:
- Aleatoric uncertainty: Irreducible noise (1/alpha per chemical)
- Epistemic uncertainty: Model uncertainty (variance across posterior samples)
"""
